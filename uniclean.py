...
right_df = pd.read_csv('pivoted_hesa_data.csv',encoding_errors='ignore')  # The right dataset you're joining with
...
merged_df.to_csv('hesamerged_output.csv', index=False)
